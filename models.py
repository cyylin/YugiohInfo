...
class Cardtyperef(models.Model):
    cardtype = models.IntegerField(db_column='CardType', unique=True)  # Field name made lowercase.
...
class Registercard(models.Model):
    cardno = models.CharField(db_column='CardNo', unique=True, max_length=20)  # Field name made lowercase.
